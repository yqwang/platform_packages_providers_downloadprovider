...
public class DownloadManager {
    ...
    /**
     * Value of {@link #COLUMN_REASON} when the download is paused by app.
     */
    ...
    public static class Query {
         ...
         */
        Cursor runQuery(DownloadProvider infoDb, String[] projection, Uri baseUri) {
            Uri uri = baseUri;
            ...
            return infoDb.query(uri, projection, selection, selectionArgs, orderBy);
        }
     ...
     * @hide
     */
    public DownloadManager(Context context, String packageName) {
    ...
    public int pauseDownload(long id) {
    	ContentValues values = new ContentValues();
        values.put(Downloads.Impl.COLUMN_CONTROL, 1);
        return mResolver.update(ContentUris.withAppendedId(mBaseUri, id), values,
                    null, null);
    }
    
    public int continueDownload(long id) {
    	ContentValues values = new ContentValues();
        values.put(Downloads.Impl.COLUMN_CONTROL, 0);
        return mResolver.update(ContentUris.withAppendedId(mBaseUri, id), values,
                    null, null);
    }
    ...
    public ParcelFileDescriptor openDownloadedFile(long id) throws FileNotFoundException {
        return mResolver.openFile(getDownloadUri(id), "r");
    }
	...
	public static Long getMaxBytesOverMobile(Context context) {
    	if (Integer.valueOf(android.os.Build.VERSION.SDK_INT) >= android.os.Build.VERSION_CODES.HONEYCOMB) {
    		...
    		return Long.valueOf(CommonConfig.DOWNLOAD_MAX_BYTES_OVER_MOBILE);
    	}
    }
	...
	public static Long getRecommendedMaxBytesOverMobile(Context context) {
		if (Integer.valueOf(android.os.Build.VERSION.SDK_INT) >= android.os.Build.VERSION_CODES.HONEYCOMB) {
			return android.app.DownloadManager.getRecommendedMaxBytesOverMobile(context);
		} else {
			return Long.valueOf(CommonConfig.DOWNLOAD_RECOMMENDED_MAX_BYTES_OVER_MOBILE);
		}
    }
