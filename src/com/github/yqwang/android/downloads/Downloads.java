...
public final class Downloads {
    ...
    public static final class Impl implements BaseColumns {
        ...
        public static final Uri CONTENT_URI =
                Uri.parse("content://app_downloads/my_downloads");
        ...
        public static final Uri ALL_DOWNLOADS_CONTENT_URI =
                Uri.parse("content://app_downloads/all_downloads");
        ...
        public static final Uri PUBLICLY_ACCESSIBLE_DOWNLOADS_URI =
                Uri.parse("content://app_downloads/" + PUBLICLY_ACCESSIBLE_DOWNLOADS_URI_SEGMENT);
    ...
    public static final void removeAllDownloadsByPackage(
        ...
        DownloadProvider.getInstance(context).delete(Impl.CONTENT_URI, QUERY_WHERE_CLAUSE,
